...
sub battle {
	...
	if (@winners >= 1) { # 子の勝ち
		...
		if (@winners > 1) {
			...
			$npc_com .= qq|ドッペル！！…$leaderのカードは【$ms{$leader}{card}】同じカードの人は $winners！よって、<span class="get">勝者の $winners たちそれぞれにカジノコイン <span class="damage">$s_coin</span> 枚がおくられます</span><br />|;
		}
		else {
			$npc_com .= qq|ドッペル！！…$leaderのカードは【$ms{$leader}{card}】同じカードの人は <b>$winners[0]</b>！よって、<span class="get">勝者の <b>$winners[0]</b> にカジノコイン <span class="damage">$s_coin</span> 枚がおくられます</span><br />|;
		}
		...
		$npc_com .= qq|ドッペル！！…$leaderのカードは【$ms{$leader}{card}】同じカードの人はいません！よって、<span class="get">勝者の <b>$leader</b> にカジノコイン <span class="damage">$get_coin</span> 枚がおくられます</span>|;
