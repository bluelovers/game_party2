...
#=================================================
%ten_names = (
	1.7		=> qq|<font color="#FFFF99">テンション</font>|,
	3		=> qq|<font color="#FFCC00">テンション</font>|,
	5		=> qq|<font color="#FFFF00">ハイテンション</font>|,
	8		=> qq|<font color="#FF0000">Sハイテンション</font>|,
);
sub tenshon {
	my $y = shift || $m;
	if ($ms{$y}{ten} <= 1) {
...
sub skill_31 { # 青魔道士
	return (
		...
		[44,	4,		'しのルーレット',		sub{ return if &is_bad_state('魔'); my $y=$members[int(rand(@members))]; $y = $m if $ms{$y}{hp} <= 0; $com.="死のルーレットが廻りだした！…ピッ…ピッ…ピッピッピ-[>[$y]"; if ($ms{$y}{hp} > 999 || $ms{$y}{df} > 999) { $com .= "$yにはきかなかった…"; } else { $com .= qq|<span class="die">$yは死んでしまった！</span>|; &defeat($y); };		}],
...
sub skill_46 { # ギャンブラー
	return (
		...
		[80,	4,		'しのルーレット',		sub{ return if &is_bad_state('魔'); my $y=$members[int(rand(@members))]; $y = $m if $ms{$y}{hp} <= 0; $com.="死のルーレットが廻りだした！…ピッ…ピッ…ピッピッピ-[>[$y] "; if ($ms{$y}{hp} > 999 || $ms{$y}{df} > 999) { $com .= "$yにはきかなかった…"; } else { $com .= qq|<span class="die">$yは死んでしまった！</span>|; &defeat($y); };	}],
...
sub skill_59 { # スライムライダー
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@スライム@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'mon/001.gif', 70, 120, 50, 30, 120) : $m{lv} < 70 ? &_add_party($n, 'mon/006.gif', 180, 80, 80, 50, 200) : &_add_party($n, 'mon/004.gif', 5, 10, 10, 950, 950); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@スライム@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@スライム@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(39); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@スライム@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(39); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if (rand(2)<1) { $com.='＠スラアタック '; &_damage(shift, $ms{$n}{at} * 1.5, '攻'); }elsif(rand(2)<1){ $com.='＠スラストライク '; &_damage(shift, $ms{$n}{at} * 1.2, '攻', 1); }else{ $com.='＠しゃくねつ '; &_damages(220, '息', 1); }; 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@スライム@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(39); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	100,	'がったい',				sub{ my $n = '@スライム@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(39); return if !$n || $ms{$n}{hp} <= 0; for my $k (qw/hp mp at df ag/){ my $v=$ms{$m}{$k}; $ms{$m}{$k}+=$ms{$n}{$k}; $ms{$n}{$k}+=$v; $ms{$m}{$k}=999 if $ms{$m}{$k}>999; $ms{$n}{$k}=999 if $ms{$n}{$k}>999; }; $com.=qq|<span class="tmp">$mと$nは合体した！</span>|; $ms{$m}{icon}="job/59_$m{sex}_mix.gif"; if ($n =~ /^@/) { $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; } else { $ms{$n}{icon}="job/0.gif"; } 	}],
	);
}

sub skill_60 { # ドラゴンライダー
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@ドラゴン@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'mon/083.gif', 160, 70, 180, 100, 70) : $m{lv} < 70 ? &_add_party($n, 'mon/084.gif', 250, 50, 300, 200, 100) : &_add_party($n, 'mon/224.gif', 400, 30, 400, 300, 100); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@ドラゴン@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@ドラゴン@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(41); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@ドラゴン@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(41); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if (rand(2)<1) { $com.='＠きりさく '; &_damage(shift, $ms{$n}{at} * 1.7, '攻'); }elsif(rand(2)<1){ $com.='＠たたきつぶす '; &_damage(shift, $ms{$n}{at} * 1.5, '攻', 1); }else{ $com.='＠かがやくいき '; &_damages(230, '息', 1); }; 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@ドラゴン@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(41); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	100,	'がったい',				sub{ my $n = '@ドラゴン@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(41); return if !$n || $ms{$n}{hp} <= 0; for my $k (qw/hp mp at df ag/){ my $v=$ms{$m}{$k}; $ms{$m}{$k}+=$ms{$n}{$k}; $ms{$n}{$k}+=$v; $ms{$m}{$k}=999 if $ms{$m}{$k}>999; $ms{$n}{$k}=999 if $ms{$n}{$k}>999; }; $com.=qq|<span class="tmp">$mと$nは合体した！</span>|; $ms{$m}{icon}="job/60_$m{sex}_mix.gif"; if ($n =~ /^@/) { $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; } else { $ms{$n}{icon}="job/0.gif"; } 	}],
	);
}
sub skill_61 { # ネクロマンサー
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@ゾンビ@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'mon/040.gif', 120, 120, 120, 60, 120) : $m{lv} < 70 ? &_add_party($n, 'mon/041.gif', 300, 200, 280, 90, 240) : &_add_party($n, 'mon/064.gif', 444, 444, 666, 222, 444); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@ゾンビ@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@ゾンビ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(61); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@ゾンビ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(61); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if (rand(2)<1) { $com.='＠ザラキ '; &_deaths('即死', '魔', 22); }elsif(rand(2)<1){ $com.='＠バイオガ '; $is_add_effect = 1; &_damages(120, '魔', 1); &_st_ds('猛毒', '魔', 40); }else{ $com.='＠もうどくのきり '; &_st_ds('猛毒', '息', 70); }; 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@ゾンビ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(61); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	42,		'レクイエム',			sub{ my $n = '@ゾンビ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(61); return if !$n || $ms{$n}{hp} <= 0; for my $y (@partys) { next if $ms{$y}{hp} > 0; $ms{$y}{hp}=int($ms{$y}{mhp}*0.42); $ms{$y}{at}+=300;$ms{$y}{ag}+=300; $com.=qq|<span class="revive">$yが生き返った！</span>|; $ms{$y}{icon}="mon/040.gif"; }; 	}],
	);
}
sub skill_62 { # バットマスター
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@バット@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'mon/025.gif', 90, 80, 120, 10, 180) : $m{lv} < 70 ? &_add_party($n, 'mon/026.gif', 210, 270, 170, 30, 400) : &_add_party($n, 'mon/027.gif', 410, 350, 400, 50, 600); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@バット@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@バット@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(56); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@バット@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(56); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if (rand(2)<1) { $com.='＠きゅうけつ '; my($y, $v)= &_damage(shift, 100, '魔', 1); return if !$y; &_heal($n, $v, '魔');}elsif(rand(2)<1){ $com.='＠アスピル '; my($y, $v) = &_st_down(shift, 0.3, '魔', 'mp'); return if !$y; &_mp_h($m, $v, '魔'); }else{ $com.='＠ちょうおんぱ '; &_st_ds('混乱', '歌', 70); }; 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@バット@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(56); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	37,		'ブラッドレイン',		sub{ my $n = '@バット@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(56); return if !$n || $ms{$n}{hp} <= 0; &_damages(170, '魔', 1); &_heals(150, '魔'); 	}],
	);
}
sub skill_63 { # キノコマスター
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@キノコ@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'mon/030.gif', 100, 100, 80, 50, 80) : $m{lv} < 70 ? &_add_party($n, 'mon/031.gif', 300, 80, 150, 100, 100) : &_add_party($n, 'mon/032.gif', 400, 60, 200, 100, 100); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@キノコ@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@キノコ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(63); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@キノコ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(63); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if (rand(2)<1) { $com.='＠どくのこな '; &_st_ds('猛毒', '息', 90);}elsif(rand(2)<1){ $com.='＠しびれごな '; &_st_ds('麻痺', '息', 50);}else{ $com.='＠ねむりごな '; &_st_ds('眠り', '息', 50); }; 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@キノコ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(63); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	100,	'がったい',				sub{ my $n = '@キノコ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(63); return if !$n || $ms{$n}{hp} <= 0; for my $k (qw/hp mp at df ag/){ my $v=$ms{$m}{$k}; $ms{$m}{$k}+=$ms{$n}{$k}; $ms{$n}{$k}+=$v; $ms{$m}{$k}=999 if $ms{$m}{$k}>999; $ms{$n}{$k}=999 if $ms{$n}{$k}>999; }; $com.=qq|<span class="tmp">$mと$nは合体した！</span>|; $ms{$m}{icon}="job/63_$m{sex}_mix.gif"; if ($n =~ /^@/) { $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; } else { $ms{$n}{icon}="job/0.gif"; } 	}],
	);
}
sub skill_64 { # オバケマスター
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@ゴースト@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'mon/035.gif', 100, 100, 50, 100, 100) : $m{lv} < 70 ? &_add_party($n, 'mon/036.gif', 200, 80, 100, 150, 150) : &_add_party($n, 'mon/070.gif', 300, 60, 150, 200, 200); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@ゴースト@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@ゴースト@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(64); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@ゴースト@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(64); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if (rand(2)<1) { $com.='＠ひょうい '; my($y) = &_check_enemy(shift, '操り', '息'); return if !$y; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $y; &kougeki(); $m = $buf_m; }elsif(rand(2)<1){ $com.='＠じゅばく '; &_st_d(shift, '攻封', '無', 80); }else{ $com.='＠おどろかす'; &_st_ds('動封', '攻', 60); }; 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@ゴースト@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(64); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	100,	'がったい',				sub{ my $n = '@ゴースト@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(64); return if !$n || $ms{$n}{hp} <= 0; for my $k (qw/hp mp at df ag/){ my $v=$ms{$m}{$k}; $ms{$m}{$k}+=$ms{$n}{$k}; $ms{$n}{$k}+=$v; $ms{$m}{$k}=999 if $ms{$m}{$k}>999; $ms{$n}{$k}=999 if $ms{$n}{$k}>999; }; $com.=qq|<span class="tmp">$mと$nは合体した！</span>|; $ms{$m}{icon}="job/64_$m{sex}_mix.gif"; if ($n =~ /^@/) { $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; } else { $ms{$n}{icon}="job/0.gif"; } 	}],
	);
}
sub skill_65 { # ケモノマスター
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@ケモノ@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'mon/200.gif', 100, 60, 100, 60, 180) : $m{lv} < 70 ? &_add_party($n, 'mon/206.gif', 210, 90, 300, 80, 280) : &_add_party($n, 'mon/203.gif', 400, 230, 500, 160, 400); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@ケモノ@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@ケモノ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(45); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@ケモノ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(45); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if (rand(2)<1) { $com.='＠ひっかく '; &_damage(shift, $ms{$n}{at} * 1.5, '攻'); }elsif(rand(2)<1){ $com.='＠かみつく '; &_damage(shift, $ms{$n}{at} * 1.2, '攻', 1); }else{ $com.='＠とつげき '; &_damage(shift, $ms{$n}{at} * 2.0, '攻'); }; 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@ケモノ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(45); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	40,		'どとうのけもの',		sub{ my $n = '@ケモノ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(45); return if !$n || $ms{$n}{hp} <= 0; my $v = int(rand(2)+3); for my $i (1..$v) { last if $ms{$m}{hp} <= 0; &_damage(undef, $ms{$n}{ag} * 2.0, '攻'); };	}],
	);
}
sub skill_66 { # ドクロマスター
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@ガイコツ@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'mon/043.gif', 120, 110, 160, 90, 150) : $m{lv} < 70 ? &_add_party($n, 'mon/044.gif', 240, 210, 240, 120, 180) : &_add_party($n, 'mon/056.gif', 450, 280, 400, 240, 300); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@ガイコツ@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@ガイコツ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(66); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@ガイコツ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(66); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if (rand(2)<1) { $com.='＠しのおどり '; &_deaths('即死', '踊', 20); }elsif(rand(2)<1){ $com.='＠デス '; &_death(shift, '即死', '攻', 40);}else{ $com.='＠のろい '; my @randoms = ('攻封', '動封'); for my $name (@enemys) { &_st_d($name, $randoms[int(rand(@randoms))], '魔', 75); }; }; 	 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@ガイコツ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(66); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	50,		'みんなのうらみ',		sub{ my $n = '@ガイコツ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(66); return if !$n || $ms{$n}{hp} <= 0; my $d = 100; for my $y (@partys) { $d += 420 if $ms{$y}{hp} <= 0; } &_damages($d, '無', 1); 	}],
	);
}
sub skill_67 { # バブルマスター
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@バブル@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'mon/020.gif', 90, 120, 90, 50, 90) : $m{lv} < 70 ? &_add_party($n, 'mon/021.gif', 180, 280, 160, 120, 180) : &_add_party($n, 'mon/022.gif', 8, 500, 80, 950, 950); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@バブル@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@バブル@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(40); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@バブル@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(40); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if ($ms{$n}{icon} =~ /020/) { $com.='＠ドクドク '; &_st_ds('猛毒', '息', 80); }elsif($ms{$n}{icon} =~ /021/){ $com.='＠マグマ '; &_damages(220, '息', 1); }else{ $com.='＠ジゴスパーク '; $is_add_effect = 1; &_damages(150, '魔', 1); &_st_ds('麻痺', '魔', 20);}	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@バブル@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(40); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	40,		'バブルボム',			sub{ my $n = '@バブル@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(40); return if !$n || $ms{$n}{hp} <= 0; $is_add_effect = 1; for my $y (@enemys) { my($_y) = &_damage($y, 150, '息', 1); next if rand(2)<1; $com.="$_yはあやしい液体がかかった！"; $ms{$_y}{tmp} = '２倍'; }; 	}],
	);
}
sub skill_68 { # コロヒーロー
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@コロ@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; rand(3) < 1 ? &_add_party($n, 'mon/101.gif', $ms{$m}{mhp}*0.8, $ms{$m}{mmp}*0.2, $ms{$m}{mat}*3.0, $ms{$m}{mdf}*2.0, $ms{$m}{mag}) : rand(3) < 1 ? &_add_party($n, 'mon/102.gif', $ms{$m}{mhp}*0.6, $ms{$m}{mmp}, $ms{$m}{mat}, $ms{$m}{mdf}, $ms{$m}{mag}*2.0) : &_add_party($n, 'mon/103.gif',  $ms{$m}{mhp}*0.7, $ms{$m}{mmp}, $ms{$m}{mat}*1.5, $ms{$m}{mdf}*1.5, $ms{$m}{mag}*1.5); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@コロ@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@コロ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(68); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@コロ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(68); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if ($ms{$n}{icon} =~ /101/) { $com.='＠まじんぎり '; rand(2) < 1 ? &_damage(shift, $ms{$m}{at} * 3, '攻') : &_damage(shift, 20, '攻'); }elsif($ms{$n}{icon} =~ /102/){ $com.='＠メラゾーマ '; &_damage(shift, 220, '魔', 1); }else{ $com.='＠ベホマ '; &_heal(shift, 999, '魔'); }; 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@コロ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(68); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	50,		'ベホマズン',			sub{ my $n = '@コロ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(68); return if !$n || $ms{$n}{hp} <= 0; &_heals(999, '魔');	}],
	);
}
sub skill_69 { # プチヒーロー
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@プチ@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; rand(3) < 1 ? &_add_party($n, 'mon/106.gif', $ms{$m}{mhp}*0.8, $ms{$m}{mmp}*0.2, $ms{$m}{mat}*3.0, $ms{$m}{mdf}*2.0, $ms{$m}{mag}) : rand(3) < 1 ? &_add_party($n, 'mon/107.gif', $ms{$m}{mhp}*0.6, $ms{$m}{mmp}, $ms{$m}{mat}, $ms{$m}{mdf}, $ms{$m}{mag}*2.0) : &_add_party($n, 'mon/108.gif',  $ms{$m}{mhp}*0.7, $ms{$m}{mmp}, $ms{$m}{mat}*1.5, $ms{$m}{mdf}*1.5, $ms{$m}{mag}*1.5); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@プチ@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@プチ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(69); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@プチ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(69); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if ($ms{$n}{icon} =~ /106/) { $com.='＠まじんぎり '; rand(2) < 1 ? &_damage(shift, $ms{$m}{at} * 3, '攻') : &_damage(shift, 20, '攻'); }elsif($ms{$n}{icon} =~ /107/){ $com.='＠メラゾーマ '; &_damage(shift, 220, '魔', 1); }else{ $com.='＠ベホマ '; &_heal(shift, 999, '魔'); }; 	}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@プチ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(69); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	20,		'ミナデイン',			sub{ my $n = '@プチ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(69); return if !$n || $ms{$n}{hp} <= 0; my($y) = &_check_enemy(shift, '皆', '魔'); return if !$y; my $d = 100; for my $name (@partys) { next if $m eq $name || $ms{$name}{mp} < 5; $ms{$name}{mp}-=5; $d += 85; }; $com.=qq|$mは仲間のみんなから力を受けとった！| if $d > 100; &_damage($y, $d, '魔', 1);	}],
	);
}
sub skill_70 { # 天竜人
	return (
...
# Ver1.20～追加分
sub skill_71 { # チョコボライダー
	return (
		[10,	30,		'よびだす',				sub{ my $n = '@チョコボ@'; if (defined $ms{$n}{name}) { $com.="$nを呼び出すのに失敗した…"; return; }; $m{lv} < 40 ? &_add_party($n, 'job/44_m.gif', 150, 70, 100, 50, 180) : $m{lv} < 70 ? &_add_party($n, 'chr/032.gif', 270, 50, 270, 70, 270) : &_add_party($n, 'chr/033.gif', 500, 30, 300, 300, 10); $com.="$nが戦闘に参加した！"; 	}],
		[11,	0,		'にげろ',				sub{ my $n = '@チョコボ@'; return if !defined($ms{$n}{name}) || $ms{$n}{hp} <= 0; $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; $com.="$nが戦闘から逃げ出した！"; 	}],
		[12,	0,		'こうげきめいれい',		sub{ my $n = '@チョコボ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(44); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： ＠こうげき "; $buf_m = $m; $m = $n; &kougeki(shift); $m = $buf_m;	}],
		[30,	30,		'ひっさつめいれい',		sub{ my $n = '@チョコボ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(44); return if !$n || $ms{$n}{hp} <= 0; $com.="$n： "; if (rand(3)<1) { $com.='＠チョコボキック '; &_damage(shift, $ms{$n}{at} * 1.4, '攻'); }elsif(rand(2)<1){ $com.='＠チョコケアル '; &_heal(shift, 150, '魔'); }else{ $com.='＠チョコダンス '; &_st_ds('動封', '踊', 80); }		}],
		[100,	10,		'ぼうぎょめいれい',		sub{ my $n = '@チョコボ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(44); return if !$n || $ms{$n}{hp} <= 0; $ms{$n}{tmp} = '防御'; $com.=qq|$n： ＠ぼうぎょ <span class="tmp">$nは身を固めた！</span>|;	}],
		[150,	100,	'がったい',				sub{ my $n = '@チョコボ@'; $n = defined($ms{$n}{name}) ? $n : &_search_job(44); return if !$n || $ms{$n}{hp} <= 0; for my $k (qw/hp mp at df ag/){ my $v=$ms{$m}{$k}; $ms{$m}{$k}+=$ms{$n}{$k}; $ms{$n}{$k}+=$v; $ms{$m}{$k}=999 if $ms{$m}{$k}>999; $ms{$n}{$k}=999 if $ms{$n}{$k}>999; }; $com.=qq|<span class="tmp">$mと$nは合体した！</span>|; $ms{$m}{icon}="job/71_$m{sex}_mix.gif"; if ($n =~ /^@/) { $ms{$n}{color}=$npc_color; $ms{$n}{hp}=0; } else { $ms{$n}{icon}="job/0.gif"; } 	}],
	);
}
sub skill_72 { # 算術士
	return (
...
sub skill_97 { # 超攻撃型(破壊神[king1]、カタストロフィー[21]、ルシファー[20])
	return (
