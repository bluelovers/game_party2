...
#	[0]No,	[1]名前,			[2]価格,	[3]攻撃力,				[4]重さ,		
	...
	[26,	'ﾄﾞﾗｺﾞﾝﾃｨﾙ',		19500,		int(rand(120)),			45,					],
...
# ※使用可能場所[0=自動(ダーマ神殿など),1=戦闘中の＠どうぐ,2=＠ほーむ]
#=================================================
@ites = (
#	[0]No,	[1]名前,			[2]価格,[3]※使用場所,	[4]効果
	[0,		'なし',				0,			0,			sub{	}],
	[1,		'薬草',				30,			1,			sub{ &_heal(shift, 30, '道具');		}],
	[2,		'上薬草',			100,		1,			sub{ &_heal(shift, 60, '道具');		}],
	[3,		'特薬草',			300,		1,			sub{ &_heal(shift, 120, '道具');	}],
	[4,		'賢者の石',			1500,		1,			sub{ &_heals(120, '道具');	}],
	...
	[43,	'へんげの杖',		1000,		2,			sub{ my $no = sprintf("%03d",int(rand(108)+1)); $no = '001' unless -f "$icondir/mon/$no.gif"; $m{icon} = "mon/$no.gif"; $com.="$mはモンスターに姿を変えた！"	}],
	...
	[72,	'身代わり人形',		800,		1,			sub{ my $n = '@ﾀﾞﾐｰ@'; if (defined $ms{$n}{name}) { $com.="しかし、身代わり人形は消滅した…"; } else { &_add_party($n, 'item/001.gif', 150, 999,  500,  50, 150); };	}],
	[73,	'身代わり石像',		1000,		1,			sub{ my $n = '@ﾀﾞﾐｰ@'; if (defined $ms{$n}{name}) { $com.="しかし、身代わり石像は消滅した…"; } else { &_add_party($n, 'item/002.gif', 100, 300,  800, 900, 100); };	}],
	[74,	'身代わり騎士',		1200,		1,			sub{ my $n = '@ﾀﾞﾐｰ@'; if (defined $ms{$n}{name}) { $com.="しかし、身代わり騎士は消滅した…"; } else { &_add_party($n, 'item/003.gif', 400, 600, 1200, 200, 200); };	}],
