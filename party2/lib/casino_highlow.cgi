...
sub battle {
	...
	if (@members > 2 && $higher && $lower) { # ２人以上 賞金２分割
		...
		$npc_com .= qq|ハイを宣言したカードの中で一番強いカードは【$cards[$max_card]】！よって、<span class="get">勝者の $higher にカジノコイン <span class="damage">$get_coin</span> 枚がおくられます</span>|;
		$npc_com .= qq|<br />ロウを宣言したカードの中で一番弱いカードは【$cards[$min_card]】！よって、<span class="get">勝者の $lower にカジノコイン <span class="damage">$get_coin</span> 枚がおくられます</span>|;
	}
	elsif ($higher) {
		@winners = ($higher);
		$npc_com .= qq|ハイを宣言したカードの中で一番強いカードは【$cards[$max_card]】！よって、<span class="get">勝者の $higher にカジノコイン <span class="damage">$get_coin</span> 枚がおくられます</span>|;
		...
		@winners = ($lower);
		$npc_com .= qq|ロウを宣言したカードの中で一番弱いカードは【$cards[$min_card]】！よって、<span class="get">勝者の $lower にカジノコイン <span class="damage">$get_coin</span> 枚がおくられます</span>|;
	}
	else {
