...
sub event_C { return if $event =~ /C|D/; $event .= 'C'; if (rand(3)<1) { $npc_com.= "<b>！！！！？</b>床に描かれている魔法陣が反応した！"; &_heals(rand(100), '無'); } else { $npc_com.= "<b>！！！！？</b>ガラガラガラッ！頭上から大きな岩が落ちてきた！"; &_trap_d(120); };  }
